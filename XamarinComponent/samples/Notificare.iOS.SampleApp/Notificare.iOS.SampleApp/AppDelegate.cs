...
namespace Notificare.iOS.SampleApp
{
	...
	public class AppDelegate : UIApplicationDelegate
	{
		...
		{
			NotificarePushLib.Shared().HandleActionForNotificationWithData((NSString)actionIdentifier, remoteNotificationInfo, null, (NSDictionary info) =>
			{
				completionHandler();
			}, (NSError error) =>
			{
		...
		{
			NotificarePushLib.Shared().HandleActionForNotificationWithData((NSString)actionIdentifier, remoteNotificationInfo, responseInfo, (NSDictionary info) =>
			{
				completionHandler();
			}, (NSError error) =>
			{
